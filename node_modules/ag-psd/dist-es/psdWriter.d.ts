...
export declare function writeUint16LE(writer: PsdWriter, value: number): void;
export declare function writeInt32(writer: PsdWriter, value: number): void;
export declare function writeInt32LE(writer: PsdWriter, value: number): void;
...
export declare function writeUnicodeStringWithoutLength(writer: PsdWriter, text: string): void;
export declare function writeUnicodeStringWithoutLengthLE(writer: PsdWriter, text: string): void;
